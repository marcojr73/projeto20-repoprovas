/*
  ...
  - A unique constraint covering the columns `[categoryId,teacherDisciplineId]` on the table `tests` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "tests_categoryId_teacherDisciplineId_key" ON "tests"("categoryId", "teacherDisciplineId");
